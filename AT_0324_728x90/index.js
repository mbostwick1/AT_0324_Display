...
}).prototype = getMCSymbolPrototype(lib.mag_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_white_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_blue_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.car4_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.car3_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.car2_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.car1_1, new cjs.Rectangle(0,0,728,90), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(740.55,117.45,0.4907,0.4907,0,0,0,19.6,29.2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regX:19.4,x:687.95,y:69},27).wait(9).to({regX:19.6,x:745.85,y:118.2},24).wait(1));

	// cta
	this.instance_1 = new lib.cta_1();
	this.instance_1.setTransform(631,41,1,1,0,0,0,631,41);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(47).to({regX:631.1,scaleX:0.8775,scaleY:0.8775,x:631.1,y:41.05},0).wait(9).to({regX:631,scaleX:1,scaleY:1,x:631,y:41},0).wait(25));
...
p.nominalBounds = new cjs.Rectangle(0,0,755.4,132.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(150,210,1,1,0,0,0,150,300);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(134).to({_off:false},0).to({y:300},31,cjs.Ease.cubicOut).wait(46));

	// car3
	this.instance_1 = new lib.car3_1();
	this.instance_1.setTransform(150,210,1,1,0,0,0,150,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(85).to({_off:false},0).to({y:300},30,cjs.Ease.cubicOut).wait(1).to({y:391},29,cjs.Ease.cubicIn).to({_off:true},20).wait(46));

	// car2
	this.instance_2 = new lib.car2_1();
	this.instance_2.setTransform(150,210,1,1,0,0,0,150,300);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(37).to({_off:false},0).to({y:300},30,cjs.Ease.cubicOut).wait(1).to({y:391},29,cjs.Ease.cubicIn).to({_off:true},68).wait(46));

	// car1
	this.instance_3 = new lib.car1_1();
	this.instance_3.setTransform(150,300,1,1,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(19).to({y:391},29,cjs.Ease.cubicIn).to({_off:true},117).wait(46));
...
p.nominalBounds = new cjs.Rectangle(0,-90,728,271);
...
}).prototype = getMCSymbolPrototype(lib.back3_1, new cjs.Rectangle(0,0,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.back1_1, new cjs.Rectangle(0,0,728.1,90), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(258,32.05,0.4729,0.4729,0,0,0,150.2,299.9);
...
}).prototype = getMCSymbolPrototype(lib.back2_1, new cjs.Rectangle(0,-6.9,728,102.60000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(42).to({graphics:mask_graphics_42,x:364,y:45}).wait(1).to({graphics:mask_graphics_43,x:364,y:45}).wait(1).to({graphics:mask_graphics_44,x:364,y:44.95}).wait(1).to({graphics:mask_graphics_45,x:364,y:44.85}).wait(1).to({graphics:mask_graphics_46,x:364,y:44.7}).wait(1).to({graphics:mask_graphics_47,x:364,y:44.4}).wait(1).to({graphics:mask_graphics_48,x:364,y:43.95}).wait(1).to({graphics:mask_graphics_49,x:364,y:43.35}).wait(1).to({graphics:mask_graphics_50,x:364,y:42.5}).wait(1).to({graphics:mask_graphics_51,x:364,y:41.45}).wait(1).to({graphics:mask_graphics_52,x:364,y:40.15}).wait(1).to({graphics:mask_graphics_53,x:364,y:38.55}).wait(1).to({graphics:mask_graphics_54,x:364,y:36.6}).wait(1).to({graphics:mask_graphics_55,x:364,y:34.35}).wait(1).to({graphics:mask_graphics_56,x:364,y:31.65}).wait(1).to({graphics:mask_graphics_57,x:364,y:28.6}).wait(1).to({graphics:mask_graphics_58,x:364,y:25.1}).wait(1).to({graphics:mask_graphics_59,x:364,y:21.15}).wait(1).to({graphics:mask_graphics_60,x:364,y:16.65}).wait(1).to({graphics:mask_graphics_61,x:364,y:11.65}).wait(1).to({graphics:mask_graphics_62,x:364,y:6.15}).wait(1).to({graphics:mask_graphics_63,x:364,y:0}).wait(1).to({graphics:mask_graphics_64,x:364,y:-6.15}).wait(1).to({graphics:mask_graphics_65,x:364,y:-11.65}).wait(1).to({graphics:mask_graphics_66,x:364,y:-16.65}).wait(1).to({graphics:mask_graphics_67,x:364,y:-21.15}).wait(1).to({graphics:mask_graphics_68,x:364,y:-25.1}).wait(1).to({graphics:mask_graphics_69,x:364,y:-28.6}).wait(1).to({graphics:mask_graphics_70,x:364,y:-31.65}).wait(1).to({graphics:mask_graphics_71,x:364,y:-34.3}).wait(1).to({graphics:mask_graphics_72,x:364,y:-36.6}).wait(1).to({graphics:mask_graphics_73,x:364,y:-38.55}).wait(1).to({graphics:mask_graphics_74,x:364,y:-40.15}).wait(1).to({graphics:mask_graphics_75,x:364,y:-41.45}).wait(1).to({graphics:mask_graphics_76,x:364,y:-42.5}).wait(1).to({graphics:mask_graphics_77,x:364,y:-43.35}).wait(1).to({graphics:mask_graphics_78,x:364,y:-43.95}).wait(1).to({graphics:mask_graphics_79,x:364,y:-44.4}).wait(1).to({graphics:mask_graphics_80,x:364,y:-44.7}).wait(1).to({graphics:mask_graphics_81,x:364,y:-44.85}).wait(1).to({graphics:mask_graphics_82,x:364,y:-44.95}).wait(1).to({graphics:mask_graphics_83,x:364,y:-45}).wait(1).to({graphics:mask_graphics_84,x:364,y:-45}).wait(1).to({graphics:mask_graphics_85,x:364,y:135}).wait(1).to({graphics:mask_graphics_86,x:364,y:135}).wait(1).to({graphics:mask_graphics_87,x:364,y:134.95}).wait(1).to({graphics:mask_graphics_88,x:364,y:134.85}).wait(1).to({graphics:mask_graphics_89,x:364,y:134.7}).wait(1).to({graphics:mask_graphics_90,x:364,y:134.4}).wait(1).to({graphics:mask_graphics_91,x:364,y:133.95}).wait(1).to({graphics:mask_graphics_92,x:364,y:133.35}).wait(1).to({graphics:mask_graphics_93,x:364,y:132.5}).wait(1).to({graphics:mask_graphics_94,x:364,y:131.45}).wait(1).to({graphics:mask_graphics_95,x:364,y:130.15}).wait(1).to({graphics:mask_graphics_96,x:364,y:128.55}).wait(1).to({graphics:mask_graphics_97,x:364,y:126.6}).wait(1).to({graphics:mask_graphics_98,x:364,y:124.35}).wait(1).to({graphics:mask_graphics_99,x:364,y:121.65}).wait(1).to({graphics:mask_graphics_100,x:364,y:118.6}).wait(1).to({graphics:mask_graphics_101,x:364,y:115.1}).wait(1).to({graphics:mask_graphics_102,x:364,y:111.15}).wait(1).to({graphics:mask_graphics_103,x:364,y:106.65}).wait(1).to({graphics:mask_graphics_104,x:364,y:101.65}).wait(1).to({graphics:mask_graphics_105,x:364,y:96.15}).wait(1).to({graphics:mask_graphics_106,x:364,y:90}).wait(1).to({graphics:mask_graphics_107,x:364,y:83.85}).wait(1).to({graphics:mask_graphics_108,x:364,y:78.35}).wait(1).to({graphics:mask_graphics_109,x:364,y:73.35}).wait(1).to({graphics:mask_graphics_110,x:364,y:68.85}).wait(1).to({graphics:mask_graphics_111,x:364,y:64.9}).wait(1).to({graphics:mask_graphics_112,x:364,y:61.4}).wait(1).to({graphics:mask_graphics_113,x:364,y:58.35}).wait(1).to({graphics:mask_graphics_114,x:364,y:55.7}).wait(1).to({graphics:mask_graphics_115,x:364,y:53.4}).wait(1).to({graphics:mask_graphics_116,x:364,y:51.45}).wait(1).to({graphics:mask_graphics_117,x:364,y:49.85}).wait(1).to({graphics:mask_graphics_118,x:364,y:48.55}).wait(1).to({graphics:mask_graphics_119,x:364,y:47.5}).wait(1).to({graphics:mask_graphics_120,x:364,y:46.65}).wait(1).to({graphics:mask_graphics_121,x:364,y:46.05}).wait(1).to({graphics:mask_graphics_122,x:364,y:45.6}).wait(1).to({graphics:mask_graphics_123,x:364,y:45.3}).wait(1).to({graphics:mask_graphics_124,x:364,y:45.15}).wait(1).to({graphics:mask_graphics_125,x:364,y:45.05}).wait(1).to({graphics:mask_graphics_126,x:364,y:45}).wait(1).to({graphics:mask_graphics_127,x:364,y:45}).wait(175));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:390},42,cjs.Ease.cubicInOut).wait(260));

	// back2
	this.instance_2 = new lib.back2_1();
	this.instance_2.setTransform(150,300,1,1,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(42).to({y:210},42,cjs.Ease.cubicInOut).wait(218));

	// mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_42 = new cjs.Graphics().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	var mask_1_graphics_85 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_86 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_87 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_88 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_89 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_90 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_91 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_92 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_93 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_94 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_95 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_96 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_97 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_98 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_99 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_100 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_101 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_102 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	...
	var mask_1_graphics_106 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_107 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_108 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_109 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_110 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_111 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_112 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_113 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_114 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_115 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_116 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_117 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_118 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_119 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_120 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_121 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_122 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_123 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_124 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_125 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_126 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	var mask_1_graphics_127 = new cjs.Graphics().p("Eg43AHCIAAuDMBxvAAAIAAODg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(42).to({graphics:mask_1_graphics_42,x:150,y:300}).wait(43).to({graphics:mask_1_graphics_85,x:364,y:45}).wait(1).to({graphics:mask_1_graphics_86,x:364,y:45}).wait(1).to({graphics:mask_1_graphics_87,x:364,y:45.05}).wait(1).to({graphics:mask_1_graphics_88,x:364,y:45.15}).wait(1).to({graphics:mask_1_graphics_89,x:364,y:45.3}).wait(1).to({graphics:mask_1_graphics_90,x:364,y:45.6}).wait(1).to({graphics:mask_1_graphics_91,x:364,y:46.05}).wait(1).to({graphics:mask_1_graphics_92,x:364,y:46.65}).wait(1).to({graphics:mask_1_graphics_93,x:364,y:47.5}).wait(1).to({graphics:mask_1_graphics_94,x:364,y:48.55}).wait(1).to({graphics:mask_1_graphics_95,x:364,y:49.85}).wait(1).to({graphics:mask_1_graphics_96,x:364,y:51.45}).wait(1).to({graphics:mask_1_graphics_97,x:364,y:53.4}).wait(1).to({graphics:mask_1_graphics_98,x:364,y:55.65}).wait(1).to({graphics:mask_1_graphics_99,x:364,y:58.35}).wait(1).to({graphics:mask_1_graphics_100,x:364,y:61.4}).wait(1).to({graphics:mask_1_graphics_101,x:364,y:64.9}).wait(1).to({graphics:mask_1_graphics_102,x:364,y:68.85}).wait(1).to({graphics:mask_1_graphics_103,x:364,y:73.35}).wait(1).to({graphics:mask_1_graphics_104,x:364,y:78.35}).wait(1).to({graphics:mask_1_graphics_105,x:364,y:83.85}).wait(1).to({graphics:mask_1_graphics_106,x:364,y:90}).wait(1).to({graphics:mask_1_graphics_107,x:364,y:96.15}).wait(1).to({graphics:mask_1_graphics_108,x:364,y:101.65}).wait(1).to({graphics:mask_1_graphics_109,x:364,y:106.65}).wait(1).to({graphics:mask_1_graphics_110,x:364,y:111.15}).wait(1).to({graphics:mask_1_graphics_111,x:364,y:115.1}).wait(1).to({graphics:mask_1_graphics_112,x:364,y:118.6}).wait(1).to({graphics:mask_1_graphics_113,x:364,y:121.65}).wait(1).to({graphics:mask_1_graphics_114,x:364,y:124.3}).wait(1).to({graphics:mask_1_graphics_115,x:364,y:126.6}).wait(1).to({graphics:mask_1_graphics_116,x:364,y:128.55}).wait(1).to({graphics:mask_1_graphics_117,x:364,y:130.15}).wait(1).to({graphics:mask_1_graphics_118,x:364,y:131.45}).wait(1).to({graphics:mask_1_graphics_119,x:364,y:132.5}).wait(1).to({graphics:mask_1_graphics_120,x:364,y:133.35}).wait(1).to({graphics:mask_1_graphics_121,x:364,y:133.95}).wait(1).to({graphics:mask_1_graphics_122,x:364,y:134.4}).wait(1).to({graphics:mask_1_graphics_123,x:364,y:134.7}).wait(1).to({graphics:mask_1_graphics_124,x:364,y:134.85}).wait(1).to({graphics:mask_1_graphics_125,x:364,y:134.95}).wait(1).to({graphics:mask_1_graphics_126,x:364,y:135}).wait(1).to({graphics:mask_1_graphics_127,x:364,y:135}).wait(175));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(85).to({y:390},42,cjs.Ease.cubicInOut).wait(175));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(85).to({_off:false},0).wait(42).to({y:210},42,cjs.Ease.cubicInOut).wait(133));
...
p.nominalBounds = new cjs.Rectangle(363,-51.8,366,231.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1711390604548", id:"back1"},
		{src:"images/back2.jpg?1711390604548", id:"back2"},
		{src:"images/back3.jpg?1711390604548", id:"back3"},
		{src:"images/back4.jpg?1711390604548", id:"back4"},
		{src:"images/back5.jpg?1711390604548", id:"back5"},
		{src:"images/car1.png?1711390604548", id:"car1"},
		{src:"images/car2.png?1711390604548", id:"car2"},
		{src:"images/car3.png?1711390604548", id:"car3"},
		{src:"images/car4.png?1711390604548", id:"car4"},
		{src:"images/cta.png?1711390604548", id:"cta"},
		{src:"images/logo_blue.png?1711390604548", id:"logo_blue"},
		{src:"images/logo_white.png?1711390604548", id:"logo_white"},
		{src:"images/mag.png?1711390604548", id:"mag"},
		{src:"images/mouse.png?1711390604548", id:"mouse"},
		{src:"images/text1.png?1711390604548", id:"text1"},
		{src:"images/text2.png?1711390604548", id:"text2"},
		{src:"images/text3.png?1711390604548", id:"text3"},
		{src:"images/text4.png?1711390604548", id:"text4"},
		{src:"images/text5.png?1711390604548", id:"text5"}
	],
	preloads: []
};
